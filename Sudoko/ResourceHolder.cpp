...
ResourceHolder::ResourceHolder(): 
	...
	background_color(0xf99870FF), chosen_square_color(0x708090AA), 
	red_color(0xFF0000FF), clear_color(0xFFFFFF00), black_color(0x000000FF), blue_color(0x0000FFFF),
	button_color(0x536878FF), button_line_color(0x000000FF)
{
	...
	//Header
	sf::Text headline("Sudoku By Ouasli Oumaima", bohemian_font, 35);
	...
	sf::Text manual_entry_text("Close Sudoku", bohemian_font, button_text_size);
